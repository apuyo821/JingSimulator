...
public class creditContext : MonoBehaviour
{
    ...
    public void showSoGam()
    {
        switch (memberIndex)
        {
            ...
            //kiny.
            case 2:
                contextDummy = "BGM을 담당하면서 새로운 시도도 많이 해봤고 머리를 쥐어짜면서 만들었던 곡들을 사용해주신 다는게 정말 감사했습니다. \n후반에 가면서 시험기간이랑 겹쳐 조금 일정이 빡빡했던 부분이 있었지만 잘 해쳐나갔던 것 같습니다. \n팀장님이 진짜 하나하나 다 잘 설명해주셔서 힘들지는 않았습니다. \n팀원들도 다들 고생하셨습니다! \n재미있게 플레이 되었으면 좋겠네요, 킹아";
                favoriteImage.sprite = favoriteSprite[3];
                context.text = contextDummy;
                nameText.text = "kiny.";
                break;
            ...
            //김커일
            case 3:
                contextDummy = "작업하는 기간 동안 즐거웠습니다";
            ...
            //오메늘영
            case 8:
                contextDummy = "첫 조공작업을 버거님 조공작업으로 할 수 있어서 정말 즐거웠고  재밌게 즐겨주셨길 바랍니다! 함께 한 우리팀원들도 다들 수고많으셨습니다!";
                favoriteImage.sprite = favoriteSprite[1];
                context.text = contextDummy;
                nameText.text = "오메늘영";
                break;
            ...
            //뉸서
            case 12:
                contextDummy = "버거님 생일 조공 징버거의 성장일지 Ui로 참여하게 되어서 영광이었습니다 한 달 정도 되는 시간동안 제작하게 되었는데 팀원분들 모두 다 수고 많으셨고 감사했습니다! 버거님 생일 축하드립니다 !";
                favoriteImage.sprite = favoriteSprite[0];
                context.text = contextDummy;
                nameText.text = "뉸서";
                break;
            ...
            //종멸
            case 14:
                contextDummy = "안녕하세요, 타이틀 작업을 맡은 멸종된공룡이라고 합니다. 게임 제작이 거의 마무리되었을 때 참여하여 숟가락만 얹었지만, 타이틀 제작이 처음이라 굉장히 재미있었습니다. 버거님의 팬 게임이었기에 더욱 의미가 깊었습니다. 앞으로도 열심히 작업 활동 이어가겠습니다. 감사합니다!";
                favoriteImage.sprite = favoriteSprite[2];
                context.text = contextDummy;
                nameText.text = "멸종된공룡";
                break;
